  ...
  popular: [
    {
      ...
      by: "Trello Team",
      desc: "Track all your to-dos in your own, private Trello board.",
    ...
    },
    {
      ...
      gradient: "linear-gradient(135deg, #4bce97, #216e4e)",
    },
    {
      id: "t-pop-3",
      title: "Tier List",
      by: "Trello Engineering",
      desc: "Rank items from best to worst using a powerful visual tier list.",
  ...
  "small-business": [
    {
      ...
      by: "Trello Team",
      desc: "Manage your clients and sales pipeline with this lightweight CRM.",
      gradient: "linear-gradient(135deg, #f5cd47, #d29034)",
    },
    {
      id: "t-sb-2",
      title: "Budget Tracker",
      by: "Community",
      desc: "Keep your business finances organised and visible at a glance.",
      gradient: "linear-gradient(135deg, #4bce97, #0c66e4)",
    },
  ],
  design: [
    {
      ...
      title: "Design Sprint",
      by: "Trello Design",
      desc: "Run a full Design Sprint process in 5 days.",
      gradient: "linear-gradient(135deg, #e774bb, #c377e0)",
    },
    {
      id: "t-des-2",
      title: "UI Component Library",
      by: "Community",
      desc: "Track design tokens, components and releases.",
      gradient: "linear-gradient(135deg, #cd5a91, #89609e)",
    },
  ],
  education: [
    {
      ...
      by: "Trello Team",
      desc: "Organise assignments, exams and study sessions.",
      gradient: "linear-gradient(135deg, #f5cd47, #fea362)",
    },
    {
      id: "t-edu-2",
      title: "Lesson Planner",
      by: "Community",
      desc: "Plan weekly lessons and teaching resources.",
      gradient: "linear-gradient(135deg, #519839, #4bce97)",
    },
  ],
  "engineering-it": [
    {
      ...
      by: "Trello Engineering",
      desc: "Manage Agile sprints with built-in velocity tracking.",
      gradient: "linear-gradient(135deg, #9f8fef, #0c66e4)",
    },
    {
      id: "t-eng-2",
      title: "Incident Response",
      by: "Community",
      desc: "Coordinate on-call response with clear priority lanes.",
      gradient: "linear-gradient(135deg, #f87168, #b04632)",
    },
  ],
  marketing: [
    {
      ...
      by: "Trello Team",
      desc: "Plan, write and schedule your content pipeline.",
      gradient: "linear-gradient(135deg, #6cc3e0, #00aecc)",
    },
    {
      id: "t-mkt-2",
      title: "Campaign Tracker",
      by: "Community",
      desc: "Track marketing campaigns from kick-off to launch.",
      gradient: "linear-gradient(135deg, #579dff, #cd5a91)",
    },
  ],
  hr: [
    {
      ...
      by: "Trello Team",
      desc: "Track candidates from applied to hired.",
      gradient: "linear-gradient(135deg, #4bce97, #0079bf)",
    },
    {
      id: "t-hr-2",
      title: "Performance Review",
      by: "Community",
      desc: "Run structured quarterly performance reviews.",
      gradient: "linear-gradient(135deg, #fea362, #f87168)",
    },
  ],
  operations: [
    {
      ...
      by: "Trello Team",
      desc: "Manage any project end-to-end with this flexible tracker.",
      gradient: "linear-gradient(135deg, #838c91, #a9abaf)",
    },
    {
      id: "t-ops-2",
      title: "Vendor Management",
      by: "Community",
      desc: "Keep track of vendors, contracts and delivery milestones.",
      gradient: "linear-gradient(135deg, #d29034, #e6a530)",
    },
  ],
  "sales-crm": [
    {
      ...
      by: "Trello Team",
      desc: "Track deals from prospect to close with clear pipeline stages.",
      gradient: "linear-gradient(135deg, #579dff, #0c66e4)",
    },
    {
      id: "t-crm-2",
      ...
      by: "Community",
      desc: "Manage key accounts and renewal dates at a glance.",
      gradient: "linear-gradient(135deg, #4bce97, #216e4e)",
    },
  ],
};
...
const Dashboard = ({
  ...
  const getGradient = (index) =>
    BOARD_GRADIENTS[index % BOARD_GRADIENTS.length];
  ...
  const visibleTemplates =
    TEMPLATE_DATA[selectedCategory] ?? TEMPLATE_DATA.popular;
          ...
          {boards.length > 0 && (
            <div className="recently-viewed-section">
              ...
              <div className="boards-grid">
                {boards
                  .slice(0, 4)
                  .map((board, index) => renderBoardTile(board, index))}
              </div>
            </div>
          )}
            ...
            <div className="workspace-actions-header">
              ...
              <div className="workspace-actions-right">
                ...
                <button
                  className="workspace-action-btn"
                  onClick={() =>
                    showToast("Info: Feature out of scope for this assignment.")
                  }
                >
                  <span className="icon">
                    <svg
            ...
            {boards.length === 0 ? (
              <div
                style={{
                  ...
                  borderRadius: "8px",
                  border: "1px dashed #738496",
                  marginTop: "16px",
                }}
              >
                <div style={{ fontSize: "48px", marginBottom: "16px" }}>📋</div>
                <h3 style={{ color: "#b6c2cf", marginBottom: "8px" }}>
            ...
            <form onSubmit={handleCreateBoard} className="dashboard-modal-form">
              ...
              <button
                ...
                style={{
                  ...
                  cursor: newBoardTitle.trim() ? "pointer" : "not-allowed",
                }}
              >
